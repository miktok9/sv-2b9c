    ...
    try:
        ...
        for api_version in api_versions:
            ...
            post_params = {
                ...
                'title': 'Kvinnornas historia i antiken',
                'file_url': video_url,  # Use file_url instead of uploading file directly
                'published': True
            }

            print(f"[facebook] Request URL: {post_url}")
            print(f"[facebook] Parameters: title='Kvinnornas historia i antiken', file_url={video_url[:50]}..., description length={len(description_limited)}")
...
def main():
    ...
    if story_file.exists():
        ...
        description = "Kvinnornas historia i antiken 🏛️ #Kvinnohistoria #AntikHistoria #Historia #Utbildning"
