...
def main():
    ...
    # Swedish description - topic-relevant, no AI mentions
    description = f"""Upptäck den fascinerande historien om kvinnor i antika civilisationer.

Utforska lagarna, sederna, traditionerna och legendariska personligheterna som har format historien.

#Shorts #KvinnorHistoria #AntikHistoria #Utbildning"""
    
    tags = [
        'Historia', 'Antika kvinnor', 'Historiska fakta',
        'Shorts', 'Reels', 'Utbildning', 'Kultur'
    ]
