...
def generate_tts(story: str):
    ...
    print("[tts] Generating Swedish narration with edge-tts...")
    
    VOICE = "sv-SE-MattiasNeural"  # Swedish male voice (or use "sv-SE-SofieNeural" for female voice)
...
def generate_word_subtitles():
    ...
    print("[subs] Generating word-level Swedish subtitles with Vosk...")
    ...
    model_path = "vosk-model-small-sv-rhasspy-0.15"
    if not os.path.exists(model_path):
        print("[subs] Downloading Vosk Swedish model (~40 MB)...")
