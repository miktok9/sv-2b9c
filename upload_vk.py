...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "🏛️ Kvinnornas historia i antiken!\n\n#Kvinnohistoria #AntikHistoria #Historia #Utbildning"
        ...
        video = upload.video(
            ...
            name=title or 'Kvinnornas historia i antiken',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Kvinnornas historia i antiken! 🏛️"
    title = sys.argv[3] if len(sys.argv) > 3 else "Kvinnornas historia i antiken"
